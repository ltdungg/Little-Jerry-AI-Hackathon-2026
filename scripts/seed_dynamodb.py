...
AGGREGATED_METRICS = [
    {
        ...
        "overdue_task_count": 1,
        "high_risk_count": 1,
        "task_status_distribution": {"done": 5, "in_progress": 3, "todo": 3, "overdue": 1},
        "health": "amber",
    ...
    },
    {
        ...
        "overdue_task_count": 0,
        "high_risk_count": 0,
        "task_status_distribution": {"done": 3, "in_progress": 2, "todo": 3, "overdue": 0},
        "health": "green",
        "last_synced_at": "2026-07-17T00:00:00Z",
    },
]
...
def main() -> None:
    ...
    for m in AGGREGATED_METRICS:
        client.put_project_metrics(m)
        print("metrics:", m["project_id"])
    for r in RISKS:
